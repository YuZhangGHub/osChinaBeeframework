...
@implementation BrowserBoard_iPhone
{
    BOOL _showLoading;
    UIToolbar * _toolbar;
...
DEF_SINGLETON( BrowserBoard_iPhone )
...
ON_LAYOUT_VIEWS( signal )
{
    if ( _isToolbarHiden )
    {
        ...
        //Need put this config to let the HTML_Style work.
...
ON_SIGNAL3( BeeUIWebView, DID_LOAD_FAILED, signal )
{
    ...
    if ( _showLoading )
    {
        ...
        [self presentFailureTips:(@"error_network")];
    }
}
